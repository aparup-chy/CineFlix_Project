        ...
        <div class="box-body">
            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                ...
                <?php 
					$qry8=mysqli_query($con,"select * from shows where r_status=1 and theatre_id='".$_SESSION['theatre']."'");
					$no=1;
					while($mn=mysqli_fetch_array($qry8))
					{
					 $qry9=mysqli_query($con,"select * from movies where movie_id='".$mn['movie_id']."'");
					 $mov=mysqli_fetch_array($qry9);
					 $qry10=mysqli_query($con,"select * from showtime where st_id='".$mn['st_id']."'");
					 $scr=mysqli_fetch_array($qry10);
					 $qry11=mysqli_query($con,"select * from halls where screen_id='".$scr['screen_id']."'");
