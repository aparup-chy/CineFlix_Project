							...
							<?php
								...
								$shw=mysqli_fetch_array($s);
									...
									<tr>
										...
										<td>
											<?php 
												$ttm=mysqli_query($con,"select  * from showtime where st_id='".$shw['st_id']."'");
												
												$ttme=mysqli_fetch_array($ttm);
												
												$sn=mysqli_query($con,"select  * from halls where screen_id='".$ttme['screen_id']."'");
